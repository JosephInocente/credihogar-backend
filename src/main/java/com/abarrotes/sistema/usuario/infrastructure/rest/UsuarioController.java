...
public class UsuarioController {
    ...
    // 2. CREAR USUARIO (Mantenemos tu lógica con el Caso de Uso)
    @PostMapping
    public ResponseEntity<String> crearUsuario(@RequestBody CrearUsuarioRequest request) {
        try {
            ...
            // Llamamos al caso de uso pasándole el Enum convertido
    ...
    public ResponseEntity<?> editarUsuario(@PathVariable Long id, @RequestBody CrearUsuarioRequest request) {
        try {
            // Actualizamos solo los datos personales y el rol (No tocamos la contraseña por seguridad aquí)
